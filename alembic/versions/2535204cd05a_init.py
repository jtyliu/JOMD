...
def upgrade():
    ...
    op.create_table('contest',
        ...
        sa.Column('format', Json(), nullable=True),
        sa.Column('rankings', Json(), nullable=True),
    ...
    op.create_table('problem',
        ...
        sa.Column('language_resource_limits', Json(), nullable=True),
    ...
    op.create_table('submission',
        ...
        sa.Column('cases', Json(), nullable=True),
